...
export default function VerifyEmail() {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      setMessage(res.message || 'Verification email resent. Please check your inbox and spam.');
    } catch (err) {
      console.error(err);
  ...
  return (
    <div className="verify-container">
      ...
      <p>
        We’ve sent a verification link to your email {email ? <strong>{email}</strong> : 'your email address'}.
        <br />
